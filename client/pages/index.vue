      ...
      <div class="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div class="text-center">
            <h1 class="text-balance text-4xl font-bold tracking-tight text-gray-900 sm:text-7xl">Tresfjord Lyd & Lys</h1>
            <p class="mt-6 text-xl leading-8 text-gray-800">Proffesjonell lyd, lys og scene til alle dine arragement.</p>
            <div class="mt-10 flex items-center justify-center gap-x-6">
              <a href="#contact" class="rounded-md border-2 py-3 px-6 text-xl border-black bg-transparrent hover:bg-black hover:text-white text-black font-bold">Kontakt oss</a>
            </div>
          </div>
        </div>
